Wazuh active response is configured to stop powershell.exe and powershell_ise.exe processes when detected as either parent or child processes, triggered by rules 100106, 100172, or 100604.
